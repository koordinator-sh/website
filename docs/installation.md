...
| `manager.image.tag`                       | Tag for koord-manager image                                      | `0.6.0`                         |
...
| `scheduler.image.tag`                     | Tag for koord-scheduler image                                    | `0.6.0`                         |
...
| `koordlet.image.tag`                      | Tag for koordlet image                                           | `0.6.0`                         |
